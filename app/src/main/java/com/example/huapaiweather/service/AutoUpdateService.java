package com.example.huapaiweather.service;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather(){
        ...
        if (weatherString != null){
            ...
            String weatherId = heWeatherBean.getBasic().getId();
            ...
            HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    WeatherBean.HeWeatherBean heWeatherBean1 = Utility.handleWeatherResponse(responseText);
                    if (heWeatherBean1 != null && "ok".equals(heWeatherBean1.getStatus())){
